...
void ImGui::ProgressBar(float fraction, const ImVec2& size_arg, const char* overlay, bool reversed) {
   ImGuiWindow* window = GetCurrentWindow();
   if (window->SkipItems)
      return;
   ...
   ImVec2 empty_br = ImVec2(ImLerp(bb.Min.x, bb.Max.x, fraction), bb.Min.y);
   ...
   RenderFrame(empty_br, bb.Max, GetColorU32(ImGuiCol_FrameBg), true, style.FrameRounding);
